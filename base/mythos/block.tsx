...
import Mythos from "../../000.mythos/99.core/state";
import * as Import from "../../000.mythos/BEE";
...
export default function MythosBlock() {
    console.log( PIVOT.MYTHOS + " block");
    ...
    if (typeof window !== 'undefined' && (window as any)[  PIVOT.MYTHOS ] == null) {
        (window as any)[ PIVOT.MYTHOS ] = sim.hunt;
    }
